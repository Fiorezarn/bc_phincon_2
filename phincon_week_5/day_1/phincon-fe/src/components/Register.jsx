    ...
    <div className="flex pt-5 pb-5 justify-center items-center bg-gray-100">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8 m-10">
        <div className="flex flex-col items-center">
          <img
            src={logoPhinconAcademy}
            alt="Phincon Academy Logo"
            className="w-100"
          />
        </div>
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <div className="mb-6">
            ...
            >
              Password{" "}
              <label className="text-xs text-blue-400">
                (min 8 and max 30 characters, with at least contains upper,
                lower, number, and special characters)
              </label>
            </label>
            <input
              type="password"
        ...
        <div className="mt-5 text-center">
          ...
          <Link
            to="/login"
            className="text-blue-400 font-bold hover:text-green-800"
          >
            Login Here
          </Link>
        </div>
